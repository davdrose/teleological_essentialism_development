...
df.exp1 = read.csv("../../data/exp1.csv")
```
...
```
## Hypotheis test of condition differneces and differnece from chance
...
df.exp2 = read.csv("../../data/exp2.csv")
```
...
df.exp3a = read_csv("../../data/exp3_part1.csv")
...
# PART 2 (What one X or Y, is for this?)
## Read in data

```{r message=FALSE, warning=FALSE}

df.exp3b = read_csv("../../data/exp3_part2.csv")
...
df.exp4 = read_csv("../../data/exp4.csv")
...
ggplot(data = df.exp4,
  ...
  labs(y = "Probability of selecting \n original thing") +
   scale_x_continuous(limits=c(4.9, 10),
                     breaks = 5:10) +
  scale_y_continuous(limits = c(0, 1),  # Set limits of y-axis
                     breaks = seq(0, 1, 0.25),
