...
## Bayes 2
```{r}
fit.brm.purpose.plot = brm(formula = response ~ 1 + kind*age + (1 | participant_number) + (1 | item), 
                     data = df.purpose,
                     family = "bernoulli",
                     seed = 1,
                     iter = 4000,
...
fit.brm.control.plot = brm(formula = response ~ 1 + kind*age + (1 | participant_number) + (1 | item),
                     data = df.control,
                     family = "bernoulli",
                     seed = 1,
                     iter = 4000,
